...
class Salarios extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = ['titulo' => 'Proyecto Taller', 'nombre' => 'Daniel Sanchez', 'salarios' => $salarios, 'empleados'=>$empleados]; // le asignamos a la variable data, que es la que interactua con la vista, los datos obtenidos del modelo, ademas de enviarle una variable titulo para el reporte.
    ...
    public function eliminados()
    {
        ...
        $data = ['titulo' => 'EMPLEADOS ELIMINADOS', 'titulo' => 'Proyecto Taller', 'nombre' => 'Daniel Sanchez', 'empleados' => $salarios];
