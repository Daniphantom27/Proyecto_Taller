...
<body style="background:#9f8756">
  <h1 class="titulo" style="font-family:monospace bold; font-size:40px"><?php echo "Administrar Cargos"; ?></h1>

  <div>
    <button type="button" class="btn btn-secondary paises_btn" data-bs-toggle="modal" data-bs-target="#agregarCargo" onclick="seleccionaCargos(<?php echo 1 . ',' . 1 ?>);"><i class="bi bi-house-add-fill"></i></button>
    <a href="<?php echo base_url('eliminados_cargos'); ?>"  class="btn btn-secondary paises_btn"><i class="bi bi-trash3-fill"></i></a>
      ...
      <tbody style="font-family:monospace;font-size:20px;">
        <?php foreach ($cargos as $dato) { ?>
          <tr>
            ...
            <td><button type="button" class="btn btn-secondary pais_actu" data-bs-toggle="modal" id="btn_guardar" data-bs-target="#agregarCargo" onclick="seleccionaCargos(<?php echo $dato['id'] . ',' . 2 ?>);">
            <i class="bi bi-pencil-fill"></i></button>

              <button type="button" class="btn btn-danger" href="#" data-href="<?php echo base_url('/cargos/eliminar') . '/' .$dato['id']. '/' .'E'; ?>"  data-bs-toggle="modal" data-bs-target="#modal-confirma" ><i class="bi bi-person-x-fill"></i></button>
            </td>
          </tr>
        <?php } ?>
      </tbody>
