...
<body style="background:#9f8756">
    <h1 class="titulo" style="font-family:monospace bold; font-size:40px"><?php echo "Administrar Departamentos"; ?></h1>   

    <div>
        <button type="button" style="font-family: monospace" class="btn btn-secondary paises_btn" data-bs-toggle="modal" data-bs-target="#añadirModal" onclick="seleccionaDepartamentos(<?php echo 1 . ',' . 1 ?>);"><i class="bi bi-house-add-fill"></i></button>

        <a style="font-family: monospace" href="<?php echo base_url('/departamentos/eliminados'); ?>"  class="btn btn-secondary paises_btn"><i class="bi bi-trash3-fill"></i></a>

        <a style="font-family: monospace" href="<?php echo base_url('/principal'); ?>" class="btn btn-secondary paises_btn"><i class="bi bi-arrow-bar-left"></i></a>
    </div>
            ...
            <tbody style="font-family:monospace;font-size:20px;">
                <?php foreach ($departamentos as $dato) { ?>
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-secondary pais_actu" data-bs-toggle="modal" id="btn_guardar" data-bs-target="#añadirModal" onclick="seleccionaDepartamentos(<?php echo $dato['id'] . ',' . 2 ?>);">
                        <i class="bi bi-pencil-fill"></i></button>
                                
                            <button type="button" href="#" data-href="<?php echo base_url('/departamentos/eliminar') . '/' .$dato['id']. '/' .'E'; ?>"  data-bs-toggle="modal" data-bs-target="#modal-confirma" class="btn btn-danger"><i class="bi bi-person-x-fill"></i></button>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
