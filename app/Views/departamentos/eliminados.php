...
<h1 class="titulo" style="font-family:monospace bold; font-size:40px"><?php echo "Departamentos Eliminados"; ?></h1>
  ...
  <div>
    ...
    <div class="card-body">
      ...
      <a href="<?php echo base_url('/departamentos'); ?>" class="btn btn-secondary paises_btn "><i class="bi bi-arrow-bar-left"></i></a>
