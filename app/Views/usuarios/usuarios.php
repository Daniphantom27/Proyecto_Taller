...
<body style="background:#9f8756">
    <h1 class="titulo" style="font-family:monospace bold; font-size:40px"><?php echo "Administrar Usuarios"; ?></h1><br>
            ...
            <tbody style="font-family:monospace;font-size:20px;">
                <?php foreach ($usuarios as $dato) { ?>
                    <tr>
                        ...
                        <td><?php echo $dato['t_identidad']; ?></td>
                        <td><?php echo $dato['n_identidad']; ?></td>
                        <td><?php echo $dato['estado']; ?></td>
                        <td><button type="button" class="btn btn-secondary pais_actu" data-bs-toggle="modal" id="btn_guardar" data-bs-target="#añadirModal" onclick="seleccionaUsuarios(<?php echo $dato['id'] . ',' . 2 ?>);">
                                <i class="bi bi-pencil-fill"></i>
                            </button>
                            <button type="button" class="btn btn-danger" href="#" data-href="<?php echo base_url('/usuarios/eliminar') . '/' . $dato['id'] . '/' . 'E'; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma"><i class="bi bi-person-x-fill"></i></button>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
    ...
    <!-- Modal -->
    <form id="formulario" method="POST" action="<?php echo base_url('/usuarios/insertarUsuarios'); ?>" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="tdedocumento" name="tdedocumento" class="form-select">
                                    <option selected value="">--Seleccionar Documento--</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="ndedocumento" id="ndedocumento">
                            </div>
                        </form>
                    </div>
            ...
            if (tp == 2) {
                ...
                $.ajax({
                    ...
                    success: function(rs) {
                        $("#tp").val(2);
                        $("#id").val(id);
                        $("#nombre_c").val(rs[0]['nombre_completo']);
                        $("#tdedocumento").val(rs[0]['t_identidad']);
                        $("#ndedocumento").val(rs[0]['n_identidad']);
