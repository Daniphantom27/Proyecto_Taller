...
<body style="background:#9f8756">
    <h1 class="titulo" style="font-family:monospace bold; font-size:40px"><?php echo "Empleados Eliminados"; ?></h1>
    ...
    <div>
                    ...
                    <tbody style="font-family:monospace;font-size:20px;">
                        <?php foreach ($empleados as $dato) { ?>
                            <tr>
                                ...
                                <td title="Activar Registro" data-bs-toggle="modal" data-bs-target="#modal-confirma" href="#" data-href="<?php echo base_url('/empleados/eliminarE') . '/' . $dato['id'] . '/' . 'A'; ?>"><i class="bi bi-arrow-clockwise"></i></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
            </div>
            <a href="<?php echo base_url('/empleados'); ?>" class="btn btn-secondary paises_btn "><i class="bi bi-arrow-bar-left"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div style="background:#ffffff"  class="modal-content">
            ...
            <script>
                function EliminaEmpleados(id) {
                    $("#id").val(id);
                    dataURL = "<?php echo base_url('/empleados/eliminados'); ?>" + "/" + id + "/" + 'A';
                    $.ajax({
                        type: "POST",
                        url: dataURL,
                        dataType: "json",
