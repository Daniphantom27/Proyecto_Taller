...
<body style="background:#9f8756">
  <h1 class="titulo" style="font-family:monospace bold; font-size:40px"><?php echo "Administrar Empleados"; ?></h1>

  <div>
    <a type="button" class="btn btn-secondary paises_btn" data-bs-toggle="modal" data-bs-target="#AgregarEmpleados" onclick="seleccionaEmpleados(<?php echo 1 . ',' . 1 ?>);"><i class="bi bi-house-add-fill"></i></a>
    <a href="<?php echo base_url('/empleados/eliminados'); ?>" class="btn btn-secondary paises_btn"><i class="bi bi-trash3-fill"></i></a>
      ...
      <tbody style="font-family:monospace;font-size:20px;">
        <?php foreach ($empleados as $dato) { ?>
          <tr>
            ...
            <td><a type="button" class="btn btn-secondary pais_actu" data-bs-toggle="modal" id="btn_guardar" data-bs-target="#AgregarEmpleados" onclick="seleccionaEmpleados(<?php echo $dato['id'] . ',' . 2 ?>);">
