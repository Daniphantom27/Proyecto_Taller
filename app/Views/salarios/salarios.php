...
<body>
  <h1 class="titulo" style="font-family: monospace"><?php echo "Administrar Salarios"; ?></h1>

  <div>
    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#AgregarSalario" onclick="seleccionaSalarios(<?php echo 1 . ',' . 1 ?>);">Agregar</button>
    <a href="<?php echo base_url('/salarios/eliminados'); ?>"  class="btn btn-secondary regresar_Btn">Eliminados</a>
      ...
      <tbody style="font-family:Arial;font-size:12px;">
        <?php foreach ($salarios as $dato) { ?>
          <tr>
            ...
            <td><button type="button" class="btn btn-info" data-bs-toggle="modal" id="btn_guardar" data-bs-target="#AgregarSalario" onclick="seleccionaSalarios(<?php echo $dato['id'] . ',' . 2 ?>);">
                <i class="bi bi-person-plus"></i></button>
              <button type="button" class="btn btn-danger" href="#" data-href="<?php echo base_url('/salarios/eliminar') . '/' .$dato['id']. '/' .'E'; ?>"  data-bs-toggle="modal" data-bs-target="#modal-confirma" ><i class="bi bi-trash3"></i></button>
            </td>
          </tr>
        <?php } ?>
      </tbody>
