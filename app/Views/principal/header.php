...
<nav class="navbar navbar-expand-lg fs-5 font-monospace" style="background-color: #eed09d;" >
    ...
    <div class="collapse navbar-collapse"  id="navbarNav">
      <ul class="navbar-nav" >
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #eed09d;">
        ...
        <li class="nav-item" style="background-color: #eed09d;">
